...
typedef enum
{
	IMAGE_UTIL_DECODE_DOWNSCALE_1_1, /** 1/1 downscale decode */
	IMAGE_UTIL_DECODE_DOWNSCALE_1_2,	/** 1/2 downscale decode */
	IMAGE_UTIL_DECODE_DOWNSCALE_1_4,	/** 1/4 downscale decode */
	IMAGE_UTIL_DECODE_DOWNSCALE_1_8,	/** 1/8 downscale decode */
} image_util_decode_scale_e;

...
*          Resolution should be set for each frame in the animated gif image, followed by image_util_encode_set_input_buffer().
*
...
*          Input buffer should be set for each frame in the animated gif image, after calling image_util_encode_set_resolution().
*
* @param[in] handle The handle to image util decoding
* @param[in] src_buffer The input image buffer
*

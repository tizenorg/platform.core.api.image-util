...
*          While encoding animated gif image, image_util_encode_gif_set_frame_count() should be set\n
...
*          image_util_encode_gif_set_frame_delay_time() should be called after this.
*
* @param[in] handle The handle to image util encoding
...
* @see image_util_encode_create()
* @see image_util_encode_set_resolution()
* @see image_util_encode_gif_set_frame_delay_time()
* @see image_util_encode_set_input_buffer()
* @see image_util_encode_set_output_path()
* @see image_util_encode_set_output_buffer()
* @see image_util_encode_run()
...
* @see image_util_encode_destroy()
*/
int image_util_encode_gif_set_frame_count(image_util_encode_h handle, unsigned int frame_count);
...
*          image_util_encode_gif_set_frame_count() should be set before calling this.\n
...
*
* @pre image_util_encode_create()
* @pre image_util_encode_gif_set_frame_count()
*
* @post image_util_encode_set_input_buffer()
* @post image_util_encode_run()/image_util_encode_run_async()
* @post image_util_encode_destroy()
...
* @see image_util_encode_create()
* @see image_util_encode_set_resolution()
* @see image_util_encode_gif_set_frame_count()
* @see image_util_encode_set_input_buffer()
* @see image_util_encode_set_output_path()
* @see image_util_encode_set_output_buffer()
* @see image_util_encode_run()
...
* @see image_util_encode_destroy()
*/
int image_util_encode_gif_set_frame_delay_time(image_util_encode_h handle, unsigned long long delay_time);
...
*          While encoding animated gif image, image_util_encode_gif_set_frame_count(),\n
*          image_util_encode_set_resolution() and image_util_encode_gif_set_frame_delay_time()\n

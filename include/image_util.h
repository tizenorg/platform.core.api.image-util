...
*
*/
int image_util_decode_create(image_util_type_e image_type, decode_encode_h *handle);
...
* @see image_util_decode_destroy()
*/
int image_util_decode_set_input_buffer(decode_encode_h handle, const unsigned char *src_buffer, unsigned long long src_size);
...
* @see image_util_decode_destroy()
*/
int image_util_decode_set_output_buffer(decode_encode_h handle, unsigned char **dst_buffer);
...
* @see image_util_decode_destroy()
*/
int image_util_decode_run(decode_encode_h handle, unsigned long *width, unsigned long *height, unsigned long long *size);
...
*
*/
int image_util_encode_create(image_util_type_e image_type, decode_encode_h *handle);
...
* @see image_util_encode_destroy()
*/
int image_util_encode_set_input_buffer(decode_encode_h handle, const unsigned char *src_buffer);
...
* @see image_util_encode_destroy()
*/
int image_util_encode_set_output_buffer(decode_encode_h handle, unsigned char **dst_buffer);

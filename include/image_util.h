...
* @see image_util_decode_destroy()
*/
int image_util_decode_get_resoution(decode_encode_h handle, unsigned long *width, unsigned long *height);
...
* @see image_util_encode_destroy()
*/
int image_util_encode_set_resoution(decode_encode_h handle, unsigned long width, unsigned long height);

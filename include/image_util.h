...
*
*/
int image_util_decode_create(decode_encode_h *handle, image_util_type_e image_type);
...
* @see image_util_decode_destroy()
*/
int image_util_decode_set_input_path(decode_encode_h handle, char * path);
...
* @see image_util_decode_destroy()
*/
int image_util_decode_set_input_buffer(decode_encode_h handle, void * src_buffer, int src_size);
...
* @see image_util_decode_destroy()
*/
int image_util_decode_set_output_buffer(decode_encode_h handle, void ** dst_buffer);

/**
* @brief Sets if the decoding should be done progressively and the amount of bytes per progression.
* @since_tizen 3.0
*
* @remarks If is_progressive is set to TRUE, then bytes should also be mentioned.
*
* @param[in] handle The handle to image util decoding
* @param[in] is_progressive Whether TRUE or FALSE
* @param[in] progressive_bytes Number of bytes to be progressed at a time.
*
* @return @c 0 on success,
*               otherwise a negative error value
*
...
* @see image_util_decode_destroy()
*/
int image_util_decode_png_set_progressive(decode_encode_h handle, bool is_progressive, unsigned int progressive_bytes);
...
* @see image_util_decode_destroy()
*/
int image_util_decode_run(decode_encode_h handle);

/**
* @brief Gets the resolution of the decoded image.
* @since_tizen 3.0
*
* @remarks This can be called after calling decode_run().
*
* @param[in] handle The handle to image util decoding
* @param[out] width Width of the decoded image
* @param[out] Height of the decoded image
*
* @return @c 0 on success,
*               otherwise a negative error value
*
...
* @retval #IMAGE_UTIL_ERROR_PERMISSION_DENIED The application does not have the privilege to call this funtion
*
* @pre image_util_decode_run().
*
* @see image_util_decode_create()
* @see image_util_decode_run()
* @see image_util_decode_destroy()
*/
int image_util_decode_get_resoution(decode_encode_h handle, unsigned int *width, unsigned int *height);
...
* @see image_util_decode_create()
*/
int image_util_decode_destroy(decode_encode_h handle);
...
*
*/
int image_util_encode_create(decode_encode_h *handle, image_util_type_e image_type);
...
* @param[out] width Width of the encoded image
* @param[out] height Height of the encoded image
*
* @return @c 0 on success,
*               otherwise a negative error value
*
...
* @see image_util_encode_destroy()
*/
int image_util_encode_set_resoution(decode_encode_h handle, unsigned int width, unsigned int height);
...
* @see image_util_decode_destroy()
*/
int image_util_encode_png_set_compression(decode_encode_h handle, image_util_png_compression_e compression);
...
* @see image_util_encode_destroy()
*/
int image_util_encode_set_input_buffer(decode_encode_h handle, void * src_buffer);
...
* @see image_util_encode_destroy()
*/
int image_util_encode_set_output_path(decode_encode_h handle, char * path);
...
* @see image_util_encode_destroy()
*/
int image_util_encode_set_output_buffer(decode_encode_h handle, void ** dst_buffer);
...
*
* @param[in] handle The handle to image util encoding
* @param[out] size of the encoded image
*
* @return @c 0 on success,
*               otherwise a negative error value
*
...
* @see image_util_encode_destroy()
*/
int image_util_encode_run(decode_encode_h handle, unsigned int * size);
...
* @see image_util_encode_create()
*/
int image_util_encode_destroy(decode_encode_h handle);
